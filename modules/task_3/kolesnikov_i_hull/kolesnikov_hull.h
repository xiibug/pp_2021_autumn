...
public:
    ...
    Point(Point* pt) { x = pt->returnX(); y = pt->returnY();
    }
    int returnX() { 
        return this->x; 
    }
    ...
    bool operator!=(Point& other) {
        return ((other.returnX()!=this->x)&&(other.returnY()!=this->y) || (other.returnX() == this->x) && (other.returnY() != this->y) || (other.returnX() != this->x) && (other.returnY() == this->y))?true:false;
    }
    bool operator==(Point& other) {
