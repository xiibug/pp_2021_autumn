...
#ifndef MODULES_TASK_2_PUDOVKIN_A_ALLREDUCE_H_
#define MODULES_TASK_2_PUDOVKIN_A_ALLREDUCE_H_
...
vector<type> getRandomVector(const size_t size) {
    ...
    for (vector<type>::size_type i = 0; i < size; ++i) {
...
#endif  // MODULES_TASK_2_PUDOVKIN_A_ALLREDUCE_H_
