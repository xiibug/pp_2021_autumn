...
std::vector<double> triangulation(std::vector<double> mat, int line, const std::vector<double>& vec);
std::vector<double> getRandomVector(const std::vector<double>& mat, int line);
...
void DataDistribution(const std::vector<double>& mat, const std::vector<double>& vec, const int& line, const std::vector<double>& mat1);
std::vector<double> gaus_metod_parall(std::vector<double> mat, std::vector<double> vec);
std::vector<double> triangulation_parall(std::vector<double> mat, int line, const std::vector<double>& vec);
