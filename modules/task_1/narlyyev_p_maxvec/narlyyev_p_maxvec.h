...
#ifndef MODULES_TASK_1_NARLYYEV_MAXVEC_NARLYYEV_MAXVEC_H_
#define MODULES_TASK_1_NARLYYEV_MAXVEC_NARLYYEV_MAXVEC_H_
#include <vector>
#include <string>
...
std::vector<double> getParallelOperations(std::vector<std::vector<double>> a,
     int m, int n);
#endif  // MODULES_TASK_1_NARLYYEV_MAXVEC_NARLYYEV_MAXVEC_H_