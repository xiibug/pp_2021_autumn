...
#ifndef MODULES_TASK_1_VITULIN_I_SUM_VECTOR_ELEMENTS_MPI_H_
#define MODULES_TASK_1_VITULIN_I_SUM_VECTOR_ELEMENTS_MPI_H_
...
#endif //MODULES_TASK_1_VITULIN_I_SUM_VECTOR_ELEMENTS_MPI_H_
