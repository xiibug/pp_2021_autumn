...
TEST(Parallel_Vector_Max_MPI, Test_Max_10) {
    int rank;
...
TEST(Parallel_Vector_Max_MPI, Test_Max_20) {
    int rank;
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
    std::vector<int> global_vec;
...
TEST(Parallel_Vector_Max_MPI, Test_Max_50) {
    int rank;
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
    std::vector<int> global_vec;
...
TEST(Parallel_Vector_Max_MPI, Test_Max_100) {
    int rank;
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
    std::vector<int> global_vec;
...
TEST(Parallel_Vector_Max_MPI, Test_Max_200) {
    int rank;
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
    std::vector<int> global_vec;
